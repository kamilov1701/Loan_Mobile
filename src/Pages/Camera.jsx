...
function Camera() {
  ...
  const handleAmountChange = (e) => {
    let digits = e.target.value.replace(/\D/g, "");
    setAmount(digits);
    setFormattedAmount(digits.replace(/\B(?=(\d{3})+(?!\d))/g, " "));
  };
  ...
  return (
    <div className="min-h-screen text-center bg-gray-100 pb-20">
      <div className="flex py-[24px] items-center justify-between px-[20px] bg-[#FFFFFF] border">
<Link to="/list"><ArrowLeft className="cursor-pointer" /></Link>
        <h2 className="text-[#111111] text-[16px] font-bold text-center">Yangi Qarz Yaratish</h2>
        <div className="w-[5px] h-[5px] bg-white"></div>
      </div>

      <section className="px-[20px] mt-4">
        <p className="text-[#6B7280] text-[11px] font-bold text-start mb-[8px]">Qarzdorning Surati</p>
        <div
          onClick={openCameraRequest}
          className="py-[37px] px-[59px] bg-[#EAF4FF] rounded-[12px] border flex flex-col items-center border-[#197FE6] cursor-pointer"
        >
          <img src={photoPath || camera} alt="" className="max-h-[120px]" />
          <p className="text-[#197FE6] text-[14px] font-bold mt-[25px]">
            Suratga Olish Uchun Ustiga Bosing
          </p>
        </div>
        ...
        {/* Sana */}
        <div className="flex gap-[20px] mt-[15px]">
          <input type="date" value={startDate} readOnly className="bg-[#FFFFFF] border-[#E5E7EB] border py-[13px] px-[15px] w-[165px] mt-[7px] rounded-[12px]" />
          <input type="date" value={deadlineDate} onChange={(e) => setDeadlineDate(e.target.value)} className="bg-[#FFFFFF] border-[#E5E7EB] border py-[13px] px-[15px] w-[165px] mt-[7px] rounded-[12px]" />
        </div>
      </section>

      {/* Bottom buttons */}
      <div className="flex py-[8px] items-end justify-between px-[17px] bg-[#ffffff] border border-[#E5E7EB] fixed bottom-0 w-full max-w-md z-10">
        <button
          onClick={handleAddLoan}
          className="bg-[#197FE6] text-[#fff] border-none px-[18px] py-[13px] rounded-[12px] text-[14px]"
        >
